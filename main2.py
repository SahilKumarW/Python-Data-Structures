...
from teaching_module_2 import TeachingModule2
...
def main():
    teaching_module = TeachingModule2()
    ...
    # Create Teachers
    teacher1 = Teacher("Dr. Wahabuddin")
    teacher2 = Teacher("Ms. Sheerina")
    teacher3 = Teacher("Mr. Faizan Ahmed Faiz")
    teacher4 = Teacher("Ms. Sana Fatima")

    # Assign Teachers to Courses
    course1.assign_teacher(teacher1)
    course2.assign_teacher(teacher2)
    course3.assign_teacher(teacher3)
    course4.assign_teacher(teacher4)

    # Add Teachers to Teaching Module
    teaching_module.add_teacher(teacher1)
    teaching_module.add_teacher(teacher2)
    teaching_module.add_teacher(teacher3)
    teaching_module.add_teacher(teacher4)
